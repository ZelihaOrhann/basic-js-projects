...
let kitap2= {isim:"Hiçbir Karşılaşma Tesadüf Değildir" , yazar:"Hakan Mengüç" ,fiyat:28, raf:"2.3 RAF"}
let kitap3= {isim:"İnsan Neyle Yaşar", yazar:"Tolstoy", fiyat: 45, raf:"3.1 RAF"}
let kitap4= {isim:"Zafer Sızlanarak Kazanılmaz", yazar:"Haluk Tatar", fiyat:34, raf:"4.4 RAF"}
let kitap5= {isim:"Şeker Portakalı", yazar:"Jose Maure de Vasconseles", fiyat:27, raf:"5.3 RAF"}
...
if(rafKod!=null){
    ...
    alert("Girdiğiniz kitap kütüphanemizde bulunmamaktadir.");
}
